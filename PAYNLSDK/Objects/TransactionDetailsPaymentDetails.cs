...
{
    /// <summary>
    /// Details regarding "transaction details" API
    /// </summary>
    public class TransactionDetailsPaymentDetails
    {
        /// <summary>
        ...
        public int? CompleteDate { get; protected set; }
        ...
        public string StartIpAddress { get; protected set; }

        /// <summary>
        /// IP address at completion
        /// </summary>
        [JsonProperty("completedIpAddress")]
        public string completedIpAddress { get; protected set; }
        ...
        public List<TransactionDetails> TransactionDetails { get; protected set; }
